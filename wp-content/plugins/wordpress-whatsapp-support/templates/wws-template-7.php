				...
				<div class="wws-popup__support wws-shadow">
					...
					<div class="wws-popup__fields_wrapper">
						...
						<div class="wws-popup__fields">
							...
							<input id="tel_number" name="tel_number" type="tel" class="wws-popup__fields-number" placeholder="<?php echo esc_attr( get_option( 'wws_number_placeholder_text' ) ) ?>" style="font-size:12px;">
							<div class="wws-popup__fields-textarea-wrapper">
							<input id="your_email" name="your_email" type="email" class="wws-popup__input wws-popup__fields-textarea" placeholder="Your Email Address" style="font-size:12px;height:0px!important;">
							</div>
							<div class="wws-popup__fields-textarea-wrapper">

								<textarea id="textarea" name="textarea" class="wws-popup__input wws-popup__fields-textarea" placeholder="<?php echo esc_attr( get_option( 'wws_input_placeholder_text' ) ) ?>" style="font-size:13px;"></textarea>

								<svg id="send-btn" class="wws-popup__send-btn" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 40" style="enable-background:new 0 0 40 40;" xml:space="preserve">
									<style type="text/css">
